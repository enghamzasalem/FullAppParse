...
angular.module('todoApp.services',[]).factory('Todo',['$http','PARSE_CREDENTIALS',function($http,PARSE_CREDENTIALS){
    return {
		 getAll2:function(){
            return $http.get('https://api.parse.com/1/classes/Comment',{
                headers:{
        ...
        create:function(data){
            return $http.post('https://api.parse.com/1/classes/Posts',data,{
                headers:{
                    'X-Parse-Application-Id': PARSE_CREDENTIALS.APP_ID,
                    'X-Parse-REST-API-Key':PARSE_CREDENTIALS.REST_API_KEY,
        ...
        edit:function(id,data){
            return $http.put('https://api.parse.com/1/classes/Posts/'+id,data,{
                headers:{
                    'X-Parse-Application-Id': PARSE_CREDENTIALS.APP_ID,
                    'X-Parse-REST-API-Key':PARSE_CREDENTIALS.REST_API_KEY,
                    'Content-Type':'application/json'
    ...
    APP_ID: 'PgdeH7r1xxMLThSXIJ5gWEWip6IDzUgfng8fWJ8Z',
    REST_API_KEY:'g8NTI0OBEBEEM0rInzbvPOjmStr5q73x1x2EhiOD'
});